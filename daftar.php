  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <h5 class="card-header judul">Daftar untuk masuk!</h5>
                    <form action="" method="post">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <button type="submit" class="btn btn-primary judul" name="btndaftar">Daftar</button>
                            </div>
                            <div class="text-center">
                                Sudah Punya akun? <a href="login.php">Masuk</a> sekarang!
                            </div>
                        </div>
                    </form>
                </div>
